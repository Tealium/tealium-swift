...
class JSONRemoteCommandPayloadBuilder {
    ...
    public class func process(trackData: [String: Any], commandConfig: RemoteCommandConfig, completion: ModuleCompletion?) -> [String: Any]? {
...
open class RemoteCommand: RemoteCommandProtocol {
    ...
    public func process(trackData: [String: Any], commandConfig: RemoteCommandConfig, completion: ModuleCompletion?) -> [String: Any]? {
        JSONRemoteCommandPayloadBuilder.process(trackData: trackData, commandConfig: commandConfig, completion: completion)
