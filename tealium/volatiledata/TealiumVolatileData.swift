...
public class TealiumVolatileData {
    ...
    required public init() {
        self.add(data:[TealiumVolatileDataKey.sessionId: newSessionId() as Any])
    }
    ...
    public func getData() -> [String:Any]{
        ...
        var data = [String:Any]()
        data[TealiumVolatileDataKey.random] = getRandom() as Any?
        data[TealiumVolatileDataKey.timestampEpoch] = getTimestampInSeconds() as Any?
        data += _volatileData
    ...
    public func setSessionId(sessionId: String) {
        self.add(data:[TealiumVolatileDataKey.sessionId: sessionId as Any])
    }
