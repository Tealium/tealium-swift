...
class TealiumDebugServer {
    ...
    internal class func stringOnly(dictionary: [String:Any]) -> [String:Any] {
        ...
        for key in dictionary.keys {
            ...
            if value is [String:Any] {
                ...
                value = TealiumDebugServer.stringOnlyArray(value as! [Any])
            }
            // Going to only pass strings in for safety - ugly but works for now.
    ...
    internal class func stringOnlyArray(_ array: [Any]) -> [String] {
        ...
        for item in array {
            ...
            if item is String {
                ...
                newItem = String(describing: item)
            }
            newArray.append(newItem as! String)
        }
