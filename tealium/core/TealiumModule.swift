...
class TealiumModule {
    ...
    func handleReport(fromModule: TealiumModule,
                      process: TealiumProcess) {
    ...
    func auto(_ process: TealiumProcess,
    ...
    func didFailToEnable(config:TealiumConfig,
                         error: Error)
    {
        let process = TealiumProcess(type: .enable,
                                     successful: false,
    ...
    func didFinishTrack(_ track: TealiumTrack){
    ...
    func didFailToTrack(_ track: TealiumTrack?,
                        error: Error){
    ...
    func didFinishReport(fromModule: TealiumModule,
                         process: TealiumProcess){
