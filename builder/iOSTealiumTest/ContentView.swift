...
struct ContentView: View {
    ...
    @State private var showAutotracking = false
        ...
        NavigationView {
            ScrollView {
                VStack(spacing: 10) {
                    ...
                    TealiumTextButton(title: "Autotracking") {
                        self.showAutotracking.toggle()
                    }.fullScreenCover(isPresented: $showAutotracking,
                                      content: AutotrackingView.init)
