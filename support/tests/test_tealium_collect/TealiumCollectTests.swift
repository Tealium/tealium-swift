...
class TealiumCollectTests: XCTestCase {
    ...
    func testDispatch() {
        ...
        let expectedURL = "https://collect.tealiumiq.com/vdata/i.gif?tealium_account=account&tealium_environment=environment&tealium_event=test&tealium_library_name=swift&tealium_library_version=1.6.1&tealium_profile=profile&tealium_random=someRandomNumber&tealium_session_id=someSessionId&tealium_visitor_id=someVisitorId"
