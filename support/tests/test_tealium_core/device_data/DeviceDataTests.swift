...
class TealiumDeviceDataTests: XCTestCase {
    ...
    func testDeviceDataCollectorMemoryEnabled() {
        ...
        XCTAssertNotNil(data["memory_free"] as? Int64)
        XCTAssertNotNil(data["memory_inactive"] as? Int64)
        XCTAssertNotNil(data["memory_wired"] as? Int64)
        XCTAssertNotNil(data["memory_active"] as? Int64)
        XCTAssertNotNil(data["memory_compressed"] as? Int64)
        XCTAssertNotNil(data["memory_physical"] as? Int64)
        XCTAssertNotNil(data["app_memory_usage"] as? Int64)
